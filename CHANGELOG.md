...
### Phase 2: Setup
**Ziel-Ende:** ~20.05.2026 | **Status:** ⏳ Supabase-Setup läuft (Juliana)
...
### Open
- **#3:** Supabase + LLM API Setup (Juliana)
- **#4:** EU AI Act Analyse (Anastasiia)
- **#5:** Julianas 5 HR-Docs (kommt noch)
...
- **#11:** Set-Auswahl rustam/ vs anastasiia/ vs juliana/ (Sync-Entscheidung)
...
- **#2b:** anastasiia/-Set 5 HR-Docs ins Repo (17.05, hochgeladen 09.05)
