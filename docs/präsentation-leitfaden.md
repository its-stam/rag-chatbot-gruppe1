...
- Liest die fünf HR-Markdown-Dateien vom Dateisystem (`hr-set-a/**/*.md`).
...
## Q&A-Vorbereitung — Theorie & Verständnis (Dozent-typisch)

Dozent fragt eher nach Verständnis und Konzepten als nach technischen Details.
...
Entscheidungen getroffen werden. (Teammitglied A)
...
Keyword-Suche kombinieren für bessere Abdeckung. (Teammitglied B — ML-Perspektive)
...
(Teammitglied B — ML-Perspektive)

### "Was war die größte Herausforderung im Projekt?"
→ Jeder eine Story: Rustam (Workflow-Debugging + LLM-Abkündigung am 30.05.),
Teammitglied A (Doku mit Live-Implementierung abgleichen — Deckblatt 2025→2026 etc.),
Teammitglied B (Supabase pgvector + match_documents zum Laufen bringen).

---

## Q&A-Vorbereitung — Technik (falls Dozent Details fragt)
