# Training and Compliance Policy — NovaWork Maschinenbau GmbH

**Dokumenttyp:** Internes HR-Dokument  
**Zielgruppe:** Alle Mitarbeiter bei NovaWork Maschinenbau GmbH, insbesondere neue Mitarbeiter  
**Gültig ab:** 01.01.2025  
**Verantwortlich:** HR-Abteilung und Compliance-Beauftragter NovaWork  
**Kontakt:** hr@novawork.de | compliance@novawork.de
...
## 1. Pflichttrainings im Onboarding bei NovaWork

Alle neuen Mitarbeiter bei NovaWork Maschinenbau GmbH müssen folgende Trainings innerhalb der angegebenen Fristen absolvieren:
...
**Folge bei Nicht-Absolvierung:** Nicht abgeschlossene Pflichttrainings werden automatisch an den direkten Vorgesetzten und die HR-Abteilung NovaWork gemeldet.

---

## 2. Jährliche Pflichttrainings (alle Mitarbeiter NovaWork)

Folgende Trainings müssen jährlich von allen Mitarbeitern bei NovaWork wiederholt werden:
...
## 3. E-Learning Plattform NovaWork

- **Zugang:** intranet.novawork.de → Bereich „Training & Entwicklung"
- **Login:** Mitarbeiter-E-Mail-Adresse, Single Sign-On über Microsoft 365
- **Verfügbarkeit:** 24/7, auch mobil nutzbar
- **Zertifikate:** Werden automatisch in der Personalakte bei NovaWork gespeichert

---

## 4. Präsenzschulungen bei NovaWork
...
| Erste Hilfe | Alle 2 Jahre | hr@novawork.de oder HR-Portal |
| Flurförderzeug-Führerschein | Bei Bedarf | Antrag über hr@novawork.de |

---

## 5. Compliance-Richtlinien NovaWork

### Verhaltenskodex (Code of Conduct)
- Gilt für alle Mitarbeiter, Führungskräfte und Dienstleister bei NovaWork
- Verbot von Korruption, Bestechung und Interessenkonflikten
- Meldepflicht bei bekannten Verstößen: compliance@novawork.de (anonym möglich)

### Datenschutz (DSGVO)
- Keine Weitergabe von Kundendaten ohne schriftliche Genehmigung der HR-/Rechtsabteilung NovaWork
- Personenbezogene Daten nur auf genehmigten NovaWork-Systemen verarbeiten
- Datenpannen (Data Breach) sofort melden: datenschutz@novawork.de
...
- Phishing-Verdacht sofort melden: it-security@novawork.de

---

## 6. Konsequenzen bei Nicht-Einhaltung
...
- Weiterbildungsbudget bei NovaWork: **500 EUR pro Mitarbeiter und Kalenderjahr**
- Antrag: Formular WB-01, Genehmigung durch Vorgesetzten und hr@novawork.de
