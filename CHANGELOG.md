...
- 🧹 Alte PRD-PDFs (v1-v4) aus Repo gelöscht, nur PRD.md + Dozent-Assignment bleiben
...
- 🔄 Firmenname bestätigt: BergTech Maschinenbau GmbH (Dozent-Vorgabe aus Transkript)
