...
**Autorin:** Teammitglied B (Supabase Lead)
**Stand:** 17.05.2026
...
Bietet Dozent-konforme "3 sichtbare Nodes"-Architektur, weil die internen 5 Sub-Nodes nicht auf dem Canvas erscheinen.
...
Dozent-Vorgabe: "n8n einfach halten." Der AI Agent Node ist intern maechtiger als er aussieht — er enthaelt 5 Sub-Nodes (LLM, Tool, Embeddings), aber auf dem Canvas sieht man nur 3. Weniger sichtbare Komplexitaet bedeutet weniger Failure-Points in der Live-Demo.
