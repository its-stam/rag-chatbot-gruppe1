...
| Req | Beschreibung | Priority |
|-----|-------------|----------|
| NFR1 | n8n: 3-4 Hauptnodes (Dozent's Tip) | MUST |
...
| **Teammitglied B** | Supabase Lead (Vorschlag) | Supabase Setup (pgvector), Schema, Embedding Storage, Retrieval-Konfiguration, Anbindung an n8n |
| **Teammitglied A** | EU AI Act Lead (vorerst) | EU AI Act Analyse: Rollen-Klassifikation (Provider/Deployer/Affected Persons/GPAI), Risikoklasse Limited-Risk, Pflichten Art. 50 + Art. 4, Compliance-Risiken + Mitigationen |
...
- Take-Aways für Doku (Teammitglied B) und Slides (Teammitglied A)

→ Teammitglied B und Teammitglied A ziehen aus dem BUILD_LOG die nötigen Inhalte für ihre Deliverables.
...
| EU AI Act ungültig | HIGH | Mit Dozent gegenchecken |
